...
*   a Logistics distribution, a Lorentzian distribution,
*   a Poisson distribution, a Beta distribution,
*   a Gamma distribution, an Erlang distribution,
...
*               21 November 2006, 21 December 2006
*
*   DOCUMENTATION:
*   See Michael Thomas Flanagan's Java library on-line web page:
*   Regression.html
*
*   Copyright (c) February 2002, August 2006, December 2006
*
*   PERMISSION TO COPY:
...
public class Regression{
    ...
    private int nData0=0;        		// number of y data points inputted (in a single array if multiple y arrays)
    ...
    private double kayValue = 0.0D;             // rate parameter value in Erlang distribution (method 35)
    ...
    private boolean supressErrorMessages= false;// = true if some designated error messages are to be supressed
    ...
    private static void regressionDetails(FileOutput fout, Regression reg){
        fout.println();
...
// method for fitting data to a scaled Heaviside Step Function
	...
	private void fitLogistic(int plotFlag){
        if(this.multipleY)throw new IllegalArgumentException("This method cannot handle multiply dimensioned y arrays");
	    this.lastMethod=30;
	    this.linNonLin = false;
	    this.zeroCheck = false;
    ...
    private void fitBeta(int allTest, int typeFlag){
        if(this.multipleY)throw new IllegalArgumentException("This method cannot handle multiply dimensioned y arrays");
	    switch(typeFlag){
    ...
    private void fitGamma(int allTest, int typeFlag){
        if(this.multipleY)throw new IllegalArgumentException("This method cannot handle multiply dimensioned y arrays");
	    switch(typeFlag){
    ...
    private void fitErlang(int allTest, int typeFlag){
        if(this.multipleY)throw new IllegalArgumentException("This method cannot handle multiply dimensioned y arrays");
	    this.lastMethod=35;
